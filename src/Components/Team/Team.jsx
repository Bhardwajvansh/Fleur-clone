...
import Pic1 from "../../Assets/team-2-img-1.png";
import Pic2 from "../../Assets/team-2-img-2.png";
import Pic3 from "../../Assets/team-2-img-3.png";
import Bg from "../../Assets/h1-parallax-2.jpeg";
                ...
                <div className="px-4 py-16 mx-auto max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-gray-600 italic max-w-3xl mx-auto">
                            Lorem ipsum dolor sit amet, consectetner gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auci elit consequat ipsutis sem niuis sed odio sit amet nibh
                        </p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {teamMembers.map((member, index) => (
                            <div key={index} className="text-center p-6 bg-white/80 rounded-lg shadow-lg">
                                ...
                                <div className="flex justify-center space-x-4">
                                    ...
                                    <a href={member.social.facebook} className="text-gray-600 hover:text-gray-900">
